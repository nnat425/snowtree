    ...
    return(
      <div className="row information-boxes">
  			<div className="col-md-4 ">
  				<div className="panel">
  					<div className="panel-heading panel-color">
  						<h4 className="font-style-header"><i className="glyphicon glyphicon-globe"></i> Services</h4>
  					</div>
  			...
  			<div className="col-md-4">
  				<div className="panel">
  					<div className="panel-heading panel-color ">
  						<h4 className="font-style-header"><i className="glyphicon glyphicon-bookmark"></i> Consultation</h4>
  					</div>
  			...
  			<div className="col-md-4">
  				<div className="panel">
  					<div className="panel-heading panel-color2">
  						<h4 className="font-style-header"><i className="glyphicon glyphicon-shopping-cart"></i> Inventory</h4>
  					</div>
